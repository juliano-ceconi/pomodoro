...
- **Regra:** Realize commits pequenos e focados em uma única mudança, em pt-br, com prefixo e descrição simples sem termos técnicos.
- **Exemplo:** "feat: adicionar funcionalidade de notificação".
...
### 3. Preservação Estética (Feminino/Rock/Geek)

- **Regra:** **PROIBIDO** quebrar a estética Feminino/Rock/Geek.
...
- Ao atualizar o `README.md` ou outros documentos, mantenha o tom
  motivacional e a estética do projeto (Feminino/Rock/Geek).
